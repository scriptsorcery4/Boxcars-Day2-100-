...
<footer className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div className="mt-16">
      ...
      <div className="mt-16 flex tems-center justify-between">
      <p className='text-[15px]'>© 2024 exemple.com. All rights reserved.</p>
        <div className='flex items-center gap-[11px]'>
            <p className='text-[15px]'>Terms & Conditions</p>
            <div className='w-[4px] h-[4px] bg-[#050B20] rounded-full'></div>
            <p className='text-[15px]'>Privacy Notice</p>
        </div>
      </div>
    </div>
  </div>
